var Constants = {
    GetCustomers : "https://localhost:44354/api/Customers/GetCustomers",
    GetCustomersById : "https://localhost:44354/api/Customers/GetCustomersById?id={id}",
    UpdateCustomersById : "https://localhost:44354/api/Customers/UpdateCustomers",
    AddCustomers : "https://localhost:44354/api/Customers/AddCustomers",
    DeleteCustomersById : "https://localhost:44354/api/Customers/DeleteCustomers?id={id}",
}
...
function updDel() {
    $("#guncelle").click(function () {
        ...
        var settings = {
            "url": Constants.UpdateCustomersById,
            "method": "PUT",
            "timeout": 0,
            "headers": {
              "Content-Type": "application/json"
    ...
    $.uptdel = {
        ...
        uptades: function (id) {
            ...
            var getById = {
                "url": Constants.GetCustomersById.replace("{id}",id),
                "method": "GET",
                "timeout": 0,
                "headers": {
                    "Content-Type": "application/json"
        ...
        deletes: function (id) {
            ...
            var settings = {
                "url": Constants.DeleteCustomersById.replace("{id}",id),
                "method": "DELETE",
                "timeout": 0,
                "headers": {
                  "token": "F1A86CC6549786284C25F4958AB8E4B1",
